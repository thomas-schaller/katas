...
into code. If you are short on time you might want to use those setups:
...
* For Ruby: [fixtures and minitest+rspec boilerplate](https://github.com/dvrensk/bank_ocr_kata)
    ...
    group.
* For Java: [Basic project & test setup](https://github.com/Pekinek/BankOCR-Java)
* For Python [Basic project & test setup](https://github.com/Pekinek/BankOCR-Python)
* For Kotlin [Basic project & test setup](https://github.com/guillaume-viland/BankOCR-Kotlin)
